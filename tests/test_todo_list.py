...
class TestToDoList(BaseClass, BaseClass.ToDoList): # testsuite
     ...
     def test_2_mark_item_as_completed_on_all_tab_and_check_completed_tab(self):
          ...
          completed_ids_from_all_tab= self.list_of_completed_ids_current_tab(TODO_COMPLETED_IDS)
          ...
          assert len(active_ids_from_all_tab) == left_items_value   # Ensure the completed item is presented on COMPLETED tab.
